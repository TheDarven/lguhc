...
public class Voyante extends RolesBis<Boolean>{
	...
	public void messageRole(PlayerLG pl) {
		if(pl.isOnline()){
			pl.getPlayer().sendMessage("§6[LGUHC] §9Tu es la Voyante, ton but est de gagner avec le village. Tu possèdes un kit ainsi que l’effet §bNight vision chaque nuit§9. Tu peux aussi, à l’aube, espionner le rôle d’un joueur à l’aide de la commande §b/lg look <player>§9.");

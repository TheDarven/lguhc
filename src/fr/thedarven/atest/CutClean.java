...
public class CutClean extends OptionBoolean {
	...
	public CutClean(String pName, String pDescription, Material pItem, InventoryGUI pParent, int pPosition, boolean pValue) {
		super(pName, pDescription, pItem, pParent, pPosition, pValue);
	}
	
	public CutClean(String pName, String pDescription, Material pItem, InventoryGUI pParent, boolean pValue) {
